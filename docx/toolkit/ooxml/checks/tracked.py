"""
Inspector for tracked changes in Word documents.
...
from kit import visible_text, unzip_safely


class TrackedChangeAuditor:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                with zipfile.ZipFile(self.original_docx, "r") as zip_ref:
                    unzip_safely(zip_ref, temp_path)
    ...
    def _rendered_text(self, elem):
        ...
        return visible_text(elem.text or "", preserve)
