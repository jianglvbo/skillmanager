"""
Inspector for Word document XML files against XSD schemas.
"""
...
from kit import unzip_safely

from .core import PackageInspector


class WordInspector(PackageInspector):
        ...
        try:
            with tempfile.TemporaryDirectory() as temp_dir:
                with zipfile.ZipFile(original, "r") as zip_ref:
                    unzip_safely(zip_ref, Path(temp_dir))
