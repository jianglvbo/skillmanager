...
description: >-
  NeoData Financial Search — 自然语言通用金融数据搜索服务。用自然语言查询股票、基金、指数、板块、 债券、期货、期权、宏观经济、外汇、大宗商品等全品类金融数据，涵盖行情报价、财务报表（财报）、 资金流向、研报评级、舆情观点、事件公告等，支持结构化API数据和财经文章两种召回模式，即问即答。 Use when the user asks about financial data, stock quotes, financial statements, earnings reports, market data, fund info, bonds, futures, options, macro economics, forex, commodities, research reports, or needs to query the NeoData API.
description_zh: "自然语言查询股票、基金、指数、板块、债券、期货、期权、宏观、外汇、大宗商品等全品类金融数据"
description_en: "Natural language financial data search (stocks, funds, indices, bonds, futures, options, macro, forex, commodities)"
version: 1.1.0
