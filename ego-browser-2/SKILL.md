...
When the user must act in the browser (slider or captcha, sign-in, consent),
bring the affected Page to the front first — any Page action activates its tab —
then call `await task.handOff()`, end the
