...
CREATE TABLE blogger_recycle_file (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `blogger_name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '博主名',
  `original_rel` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '回收前的 vault 相对路径（博主层）',
  `moved_rel` varchar(512) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '回收后的 vault 相对路径（其他层）',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='博主回收留痕表：制品从博主层挪到其他层的路径映射，恢复时据此搬回';
