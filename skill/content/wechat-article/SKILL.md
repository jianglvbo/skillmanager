...
```bash
/opt/homebrew/bin/python3 ~/Ai/skill/wechat-article/scripts/wechat_extract.py "<URL>"
```
...
```bash
/opt/homebrew/bin/python3 ~/Ai/skill/wechat-article/scripts/wechat_extract.py "<URL>" --markdown
```
