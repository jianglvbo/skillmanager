...
| 质量 | 系数 | 判断依据 |
|:---|:---:|:---|
| 精炼 | ×1.2 | 信息密度高，每段都有独立判断，无注水 |
| 正常 | ×1.0 | 有观点有论述，篇幅合理（默认） |
| 偏水 | ×0.5 | 大量篇幅讲个人生活/情绪/重复观点，可提炼信息少 |
| 注水严重 | ×0.2 | 通篇无实质判断，纯行情复述或情绪宣泄 |

> **偏水判断标准**：文章中 >50% 篇幅在讲与投资判断无关的个人日常/回忆/情感/重复性言论，且可提炼的独立观点 ≤2 条。
...
- 重组专家一篇原创中广核深度分析（案例分析 8 分 × 原创 1.0 × 精炼 1.2）= **+10 分**
- 段永平一篇转载访谈（观点评论 6 分 × 转载 0.5 × 正常 1.0）= **+3 分**
- 某博主一篇原创行情复盘，80% 篇幅聊周末去哪儿了（市场综述 3 分 × 原创 1.0 × 偏水 0.5）= **+2 分**
